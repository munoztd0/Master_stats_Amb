...
The priming condition (`r apa_lm$full_result$Priming`) and the affective score towards climate change (`r apa_lm$full_result$Behav_enviro`) did not affect price evaluation by themselves. However, the effect of affective score towards climate change on the price evalution slightly differed by priming condition, `r apa_lm$full_result$Priming_score`.
